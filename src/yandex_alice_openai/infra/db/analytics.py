...
from yandex_alice_openai.domain.models import ConversationTurn, DeferredJob, LLMReply
from yandex_alice_openai.infra.db.models import ConversationTurnRecord, JobResultRecord
